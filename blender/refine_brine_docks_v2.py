...
RENDER='/home/alfr/mercicat-rebuild/blender/saltglass_brine_docks_v2.png'
GLB='/home/alfr/mercicat-rebuild/blender/saltglass_brine_docks_v2.glb'
...
for o in list(bpy.data.objects):
    if o.name.startswith('GB_lane_'):
        bpy.data.objects.remove(o, do_unlink=True)
# All four spawn markers: identical 0.5 m radius cyan/electric-blue spheres at existing anchors.
...
# Move center cover 0.5 m toward the right wall, off the central lane convergence.
crate=bpy.data.objects.get('GB_cover_crate_center')
if not crate: raise RuntimeError('Missing center crate')
crate.location.x = 0.5
crate['reposition_note']='shifted 0.5m right toward east wall for lane clarity'
